        ...
        ServiceModel.connectPOSTURL(SIMASPAY_URL, postData:
            dict, successBlock: { (response) -> Void in
                ...
                dispatch_async(dispatch_get_main_queue()) {
                    ...
                    if( messagecode == SIMASPAY_AGENT_REGISTRATION_SUCESS || messagecode == SIMOBI_SELFBANK_TRANSFER_CONFIRM_SUCCESSCODE || messagecode == SIMOBI_LAKU_IBT_TRANSFER_CONFIRM_SUCCESSCODE || messagecode == SIMOBI_LAKU_LAKU_TRANSFER_CONFIRM_SUCCESSCODE || messagecode == SUBCRIBER_CLOSING_CONFIRMATION_SUCCESS || messagecode == SIMASPAY_CAHSIN_CONFIRMATION_SUCCESS || messagecode == SIMASPAY_CAHSOUT_CONFIRMATION_SUCCESS || messagecode == SIMAPAY_SUCCESS_PURCHASE_CODE  || messagecode == SIMAPAY_SUCCESS_PAYMENT_CODE || messagecode == SIMAPAY_SUCCESS_REFERRAL_CODE)
                    {
