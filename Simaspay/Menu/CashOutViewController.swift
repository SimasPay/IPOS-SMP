...
class CashOutViewController: UIViewController
{
    ...
    {
        //mspID=1&destPocketCode=1&institutionID=&channelID=7&bankID=&amount=10000&destMDN=6266666600030&sourceMDN=629000605607&sourcePIN=xxxxxxxxxxxxxxxxxxxxxxxxx&mfaTransaction=Inquiry&service=Wallet&accountType=&sourcePocketCode=6&txnName=CashOutInquiry
