...
class StatusViewController: UIViewController
{
    ...
    override func viewDidLoad() {
        ...
        step1FormAcceptBtn.addTarget(self, action: "popToMainViewController:", forControlEvents: UIControlEvents.TouchUpInside)
        ...
        if (self.simasPayOptionType == SimasPayOptionType.SIMASPAY_TRANSFER_BANKSINARMAS || self.simasPayOptionType == SimasPayOptionType.SIMASPAY_TRANSFER_BANK_LAIN || self.simasPayOptionType == SimasPayOptionType.SIMASPAY_TRANSFER_LAKU_PANDAI || self.simasPayOptionType == SimasPayOptionType.SIMASPAY_TARIK_TUNAI || self.simasPayOptionType == SimasPayOptionType.SIMASPAY_PEMBELIAN || self.simasPayOptionType == SimasPayOptionType.SIMASPAY_PEMBAYARAN)
        {
            ...
            transactionIDLabel.text = "ID Transaksi: 123958"
    ...
    @IBAction func popToMainViewController(sender: AnyObject) {
        ...
        {
            /*if (self.simasPayOptionType == SimasPayOptionType.SIMASPAY_SETOR_TUNAI || self.simasPayOptionType == SimasPayOptionType.SIMASPAY_TUTUP_REKENING || self.simasPayOptionType == SimasPayOptionType.SIMASPAY_REFERRAL ||  self.simasPayOptionType == SimasPayOptionType.SIMASPAY_AGENT_REGISTRATION || self.simasPayOptionType == SimasPayOptionType.SIMASPAY_TARIK_TUNAI || self.simasPayOptionType == SimasPayOptionType.SIMASPAY_PEMBELIAN || self.simasPayOptionType == SimasPayOptionType.SIMASPAY_PEMBAYARAN || self.simasPayOptionType == SimasPayOptionType.SIMASPAY_TRANSFER_BANKSINARMAS || self.simasPayOptionType == SimasPayOptionType.SIMASPAY_TRANSFER_BANK_LAIN || self.simasPayOptionType == SimasPayOptionType.SIMASPAY_TRANSFER_LAKU_PANDAI)
            {*/
