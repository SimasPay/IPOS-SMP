...
class DownloadViewController: UIViewController
{
    ...
    override func viewDidLoad() {
        ...
        optionCheckBox1.addTarget(self, action: "downloadOption1Selected:", forControlEvents: UIControlEvents.TouchUpInside)
        ...
        optionCheckBox2.addTarget(self, action: "downloadOption2Selected:", forControlEvents: UIControlEvents.TouchUpInside)
        ...
        optionCheckBox3.addTarget(self, action: "downloadOption3Selected:", forControlEvents: UIControlEvents.TouchUpInside)
        ...
        optionCheckBox4.addTarget(self, action: "downloadOption4Selected:", forControlEvents: UIControlEvents.TouchUpInside)
        ...
        option4TextField1.addTarget(self, action: "step1TextFieldEditing:", forControlEvents: .EditingDidBegin)
        ...
        option4TextField2.addTarget(self, action: "step1TextFieldEditing:", forControlEvents: .EditingDidBegin)
        ...
        step1FormAcceptBtn.addTarget(self, action: "downLoadTransactionHistory:", forControlEvents: UIControlEvents.TouchUpInside)
    ...
    @IBAction func step1TextFieldEditing(sender: UITextField) {
        ...
        if(sender.tag == 200) // To Date
        {
            ...
            periodDatePicker.minimumDate = dateFormatter.dateFromString(option4TextField1.text!)
            
        }
        periodDatePicker.maximumDate = NSDate()
        
        periodDatePicker.addTarget(self, action: Selector("datePickerValueChanged:"), forControlEvents: .ValueChanged)
