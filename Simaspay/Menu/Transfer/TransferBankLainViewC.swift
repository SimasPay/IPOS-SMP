...
class TransferBankLainViewC: UIViewController
{
    ...
    func inqueryServiceRequest ()
    {
        ...
        dict[DESTACCOUNTNUMBER] = SimaspayUtility.getNormalisedMDN(cashInFormDictonary["mobileNumber"] as! NSString)
            ...
            dict, successBlock: { (response) -> Void in
                ...
                dispatch_async(dispatch_get_main_queue()) {
                    ...
                    if( messagecode == SIMOBI_SELFBANK_TRANSFER_INQ_SUCCESSCODE)
                    {
                        ...
                        let destinationNumber = SimaspayUtility.getNormalisedMDN(self.cashInFormDictonary["mobileNumber"] as! NSString)
