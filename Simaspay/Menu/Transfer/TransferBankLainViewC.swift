...
class TransferBankLainViewC: UIViewController
{
    ...
    @IBAction func cashInAcceptClicked(sender: UIButton)
    {
        ...
        let confirmationTitlesArray : [NSString] = ["Nama Pemilik Rekening","Bank Tujuan","Nomor Rekening Tujuan","Jumlah","Biaya Transfer","Total Pendebitan"]
        let confirmationValuesArray : [NSString] = ["ANDI GUNAWAN","BCA","1122334455","Rp 2.500.000","Rp 7.500","Rp 2.507.500"]
