...
class ReferralViewController: UIViewController
{
    ...
    @IBAction func cashInAcceptClicked(sender: UIButton)
    {
        ...
        let confirmationTitlesArray : [NSString] = ["Nama Lengkap","Nomor Handphone","E-mail","Produk yang Diinginkan"]
        let confirmationValuesArray : [NSString] = ["PUTRI SETYANINGRUM","08881234567","putrisetyaningrum@gmail.com","Lainnya - Deposito"]
