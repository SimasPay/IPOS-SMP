...
class CashinViewController: UIViewController
{
    ...
    {
        //amount=10000& destMDN=6211111424& sourceMDN=8978978878& sourcePIN=xxxxxxxxxxxx& institutionID=simobi& channelID=7& service=AgentServices& authenticationKey=&bankID=&txnName=CashInInquiry
        
        var dict = NSMutableDictionary() as [NSObject : AnyObject]
        dict[SERVICE] = SERVICE_AGENT
        dict[TXNNAME] = AGENT_CASHIN_INQUERY
                ...
                dispatch_async(dispatch_get_main_queue()) {
                    ...
                    print("Confirmation Response : ",response)
                        ...
                        if( messagecode == SIMASPAY_CAHSIN_CASHOUT_INQUERY_SUCCESS)
                        {
                            ...
                            if(accountName.length > 0)
                            {
                                confirmationTitlesArray[1] = "Nomor Handphone"
