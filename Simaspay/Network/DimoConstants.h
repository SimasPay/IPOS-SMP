...
#define DIALOG_BUTTON_SIZE CGSizeMake(90.0f, 40.0f)
...
#define SIMASPAY_LOGIN_AGENT_TYPE @"2"
#define SIMASPAY_LOGIN_REGULAR_TYPE @"true"
...
#define SIMAPAY_SUCCESS_CHANGEPIN_INQUERY_CODE @""
...
#define TXN_GETPUBLC_KEY @"GetPublicKey"
#define TXN_LOGIN_KEY @"Login"
...
#define SIMASPAY_PUBLIC_KEY @"simasPayPublicKey"
...
#define  REQUEST_FALIED @"Request Failed."
...
/*  ##########################      QA   ##########################*/
/*
  #define SIMOBI_URL @"https://175.101.5.72:8444/webapi/sdynamic?channelID=7&"
  #define FLASHiZ_SERVER  ServerURLDev
  #define DOWNLOAD_PDF_URL @"https://175.101.5.72:8444/webapi/"
*/
/*  ##########################      QA   ##########################*/
