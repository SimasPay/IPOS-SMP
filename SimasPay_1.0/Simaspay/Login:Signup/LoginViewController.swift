    ...
    override func viewWillAppear(animated: Bool) {
        ...
        if(SimasPayPlistUtility.getDataFromPlistForKey(IS_LOGIN) != nil)
        {
            ...
            if isLogin == "YES"
            {
                ...
                let reloginViewController = self.storyboard!.instantiateViewControllerWithIdentifier("ReloginViewController") as! ReloginViewController
                self.navigationController!.pushViewController(reloginViewController, animated: false)
            }
        }
        ...
        ServiceModel.connectPOSTURL(SIMASPAY_URL, postData:
            dict, successBlock: { (response) -> Void in
                ...
                dispatch_async(dispatch_get_main_queue()) {
                    ...
                    {
                        SimasPayPlistUtility.saveDataToPlist("YES", key: IS_LOGIN)
