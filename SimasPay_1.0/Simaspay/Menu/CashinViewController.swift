...
class CashinViewController: UIViewController
{
    ...
    override func viewDidLoad() {
        ...
        step1FormAcceptBtn.addTarget(self, action: #selector(CashinViewController.cashInAcceptClicked(_:)), forControlEvents: UIControlEvents.TouchUpInside)
        ...
        let tap: UITapGestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(CashinViewController.dismissKeyboard))
