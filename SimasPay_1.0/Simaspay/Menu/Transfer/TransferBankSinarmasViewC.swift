...
class TransferBankSinarmasViewC: UIViewController, UITextFieldDelegate
{
    ...
    override func viewDidLoad() {
        ...
        step1FormAcceptBtn.addTarget(self, action: #selector(TransferBankSinarmasViewC.cashInAcceptClicked(_:)), forControlEvents: UIControlEvents.TouchUpInside)
        ...
        let tap: UITapGestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(TransferBankSinarmasViewC.dismissKeyboard))
    ...
    func inqueryServiceRequest ()
    {
        ...
        {
            dict[DESTBANKACCOUNT] = cashInFormDictonary["mobileNumber"] as! NSString
        ...
        if (self.simasPayOptionType == SimasPayOptionType.SIMASPAY_TRANSFER_LAKU_PANDAI || self.simasPayOptionType == SimasPayOptionType.SIMASPAY_TRANSFER_UANGKU)
        {
            ...
            if (self.simasPayOptionType == SimasPayOptionType.SIMASPAY_TRANSFER_LAKU_PANDAI){
                ...
                dict[DESTACCOUNTNUMBER] = cashInFormDictonary["mobileNumber"]
            ...
            dict, successBlock: { (response) -> Void in
                ...
                dispatch_async(dispatch_get_main_queue()) {
                    ...
                    if( messagecode == SIMOBI_SELFBANK_TRANSFER_INQ_SUCCESSCODE)
                    {
                        ...
                        if (self.simasPayOptionType == SimasPayOptionType.SIMASPAY_TRANSFER_UANGKU){
                            dict[TXNNAME] = TXN_CONFIRM_UANGKU
                        }else{
                        ...
                        var destinationNumber = self.cashInFormDictonary["mobileNumber"] as! NSString
                        ...
                        if (self.simasPayOptionType == SimasPayOptionType.SIMASPAY_TRANSFER_LAKU_PANDAI || self.simasPayOptionType == SimasPayOptionType.SIMASPAY_TRANSFER_UANGKU)
                        {
                            ...
                            if (self.simasPayOptionType == SimasPayOptionType.SIMASPAY_TRANSFER_LAKU_PANDAI)
                            {
                                accountName = responseDict.valueForKeyPath("response.ReceiverAccountName.text") as! String
                            }else{
                                accountName = responseDict.valueForKeyPath("response.destinationName.text") as! String
                            }
