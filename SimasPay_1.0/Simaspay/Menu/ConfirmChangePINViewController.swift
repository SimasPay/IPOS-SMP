...
class ConfirmChangePINViewController: UIViewController,UITextFieldDelegate,CZPickerViewDelegate
{
    ...
    override func viewDidLoad() {
        ...
        step1FormAcceptBtn.addTarget(self, action: #selector(ConfirmChangePINViewController.cashInAcceptClicked(_:)), forControlEvents: UIControlEvents.TouchUpInside)
        ...
        cancelButton.addTarget(self, action: #selector(ConfirmChangePINViewController.popToRoot(_:)), forControlEvents: UIControlEvents.TouchUpInside)
            ...
            dict, successBlock: { (response) -> Void in
                ...
                dispatch_async(dispatch_get_main_queue()) {
                    ...
                    if( messagecode == SIMAPAY_SUCCESS_CHANGEPIN_CODE )
                    {
                        ...
                        SimasPayPlistUtility.saveDataToPlist(dict[CHANGEPIN_NEWPIN], key: SOURCEPIN)
